...
/**
 * The primary key class for the EECC_DETALLE database table.
 * 
 */
@Embeddable
public class EeccDetalleEeccPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;

	@Column(name="ID_SECUENCIA", nullable=false, precision=3)
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof EeccDetalleEeccPK)) {
			return false;
		}
		EeccDetalleEeccPK castOther = (EeccDetalleEeccPK)other;
		return 
			(this.idSecuencia == castOther.idSecuencia)
	...
	public int hashCode() {
		final int prime = 31;
		int hash = 17;
		hash = hash * prime + ((int) (this.idSecuencia ^ (this.idSecuencia >>> 32)));
